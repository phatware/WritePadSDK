...
{
    /// <summary>
    /// This class contains P/Invoke function definitions for WritePad SDK. Note that some of the functions are accessed through an intermediate layer (WinRT_CPPLayer.dll).
    ...
    public static class WritePadAPI
    {
        ...
        [DllImport("WinRT_CPPLayer.dll", CallingConvention = CallingConvention.Cdecl)]
