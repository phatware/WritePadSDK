...
static BOOL _use_local_settings = YES;
...
+ (NSURL *) sharedRecoDataURL
{
    ...
    NSURL *containerURL = [[NSFileManager defaultManager]
                           containerURLForSecurityApplicationGroupIdentifier:@"group.com.phatware.writepadreco"];
    return containerURL;
}

+ (void) useLocalRecoDefaults:(BOOL)use
{
    _use_local_settings = use;
}
...
+ (NSUserDefaults *) recoGroupUserDefaults
{
    ...
    {
        NSUserDefaults*	defaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.com.phatware.writepadreco"];
