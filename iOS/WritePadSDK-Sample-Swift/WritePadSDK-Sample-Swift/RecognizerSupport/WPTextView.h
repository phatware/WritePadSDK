...
WPTextView * WPTextViewCreate( CGRect frame );

@interface WPTextView : UITextView <WritePadInputPanelDelegate, WritePadInputViewDelegate, InkCollectorViewDelegate, SuggestionsViewDelegate>
{
@private
