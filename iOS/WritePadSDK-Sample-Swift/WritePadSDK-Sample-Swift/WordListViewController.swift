...
class WordListViewController: UITableViewController, EditWordItemDelegate
{
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath)
    {
        ...
        viewController.fromWordField!.text = (item!.objectForKey( "wordFrom" ) as? String)!
        viewController.toWordField!.text = (item!.objectForKey( "wordTo" ) as? String)!
        viewController.flags = (item!.objectForKey("flags")!.intValue as Int32)
    ...
    func updateWordListItem( itemView : EditWordItemViewController )
    {
        ...
        let newWord : NSDictionary = [ "wordFrom" : itemView.fromWordField!.text!,
            "wordTo" : itemView.toWordField!.text!,
            "flags"  : NSNumber(int: itemView.flags) ]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell
    {
        ...
        {
            let item : NSDictionary? = wordList![indexPath.row] as? NSDictionary
            var text : String = (item!.objectForKey( "wordFrom" ) as? String)!
            text += " --> "
            text += (item!.objectForKey( "wordTo" ) as? String)!
